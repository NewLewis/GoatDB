...
| **分组提交最终设计 V2（RocksDB 风格流水线）** | 归档双队列流水线写入方案（WAL 阶段与 MemTable 阶段重叠），覆盖顺序语义、背压、失败矩阵与验收标准。 | [`goatkv/core/group_commit_design.md`](goatkv/core/group_commit_design.md) |
